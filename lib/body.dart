    ...
    return ListView(
      ...
      children: <Widget>[
        Container(
            ...
            child: Image.asset("images/bagus.jpg")),
        Text("NAMA    : Prawira Bagus Santoso", style: ukuran),
        Text("TTL     : Surabaya, 01 Januari 2002", style: ukuran),
        Text("NIPP    : 20.20.04101", style: ukuran),
        Text(
            ...
            onPressed: () {
              showDialog(
                  ...
                  builder: (BuildContext context) => AlertDialog(
                        ...
                        content: const Text("WELCOME Mr.Bagus"),
                        actions: <Widget>[
                          TextButton(
